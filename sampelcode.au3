...
Func Example()
        Local $aStringsToEncrypt[7] = ["AutoIt", "SciTE", "Crypt", ".au3", 42, "42","ni"]
        Local $sOutput = ""

        Local $hKey = _Crypt_DeriveKey("", $CALG_AES_256) ; Declare a password string and algorithm to create a cryptographic key.
